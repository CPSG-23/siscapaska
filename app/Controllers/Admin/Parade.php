...
class Parade extends BaseController
{
    ...
    public function index()
	{
		...
		return view('parade/index_parade', $data);
    }
    ...
    public function read($id)
	{
		...
		return view('parade/read_parade', $data);
    }
	...
	$this->form_validation->set_rules('total_nilai', 'total nilai', 'trim|required|numeric');
...
/* End of file Parade.php */
 /* Location: ./app/controllers/Parade.php */
