            ...
            <div class="row clearfix">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="float-right">
                                                    <a type="button" class="btn btn-sm btn-danger" href="<?= base_url('admin/psikotes/delete/'.$value['id'] )?>" onclick="javascript: return confirm('Delete \nAre You Sure ?')"><i class='material-icons'>delete</i></a>
                                                </span>
                                            </td>
                                        </tr>
                                        <?php  endforeach; ?>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                            <h1>Input Nilai Kesehatan</h1>
                            </h2>
                        </div>
                        <div class="body">
                            <form class="form-horizontal" method='post' action='<?=site_url('admin/psikotes/create_action')?>'>
                                <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="nilai" name='nilai' class="form-control" placeholder="Masukkan Nilai">
                                            </div>
                                        </div>
                                    </div>
                                </div>
